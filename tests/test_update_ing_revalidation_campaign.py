...
class UpdateIngCampaignTests(unittest.TestCase):
    ...
    def test_records_coverage_without_misreporting_pending_as_resolved(self) -> None:
        ...
        self.assertEqual(proof["unattemptedCount"], 0)
        self.assertEqual(proof["unresolvedCount"], 1)
        self.assertEqual(proof["remainingResolutionCount"], 1)
        self.assertEqual(proof["resolvedCount"], 1)
        self.assertFalse(proof["resolutionComplete"])
        self.assertTrue(proof["coverageVerificationComplete"])
        ...
        self.assertEqual(campaign["unattemptedCount"], 0)
        self.assertEqual(campaign["unresolvedCount"], 1)
        self.assertEqual(campaign["remainingResolutionCount"], 1)
        self.assertTrue(campaign["coverageComplete"])
        self.assertFalse(campaign["resolutionComplete"])
        self.assertTrue(campaign["coverageVerificationComplete"])
        self.assertFalse(campaign["verificationComplete"])
        self.assertTrue(
